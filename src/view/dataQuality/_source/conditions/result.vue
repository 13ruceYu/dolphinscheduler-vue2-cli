    ...
    <template slot="search-group">
      ...
      <div class="list">
        <el-select
          ...
          size="mini"
        >
          <el-option v-for="item in stateTypeList" :key="item.label" :value="item.code" :label="item.label">
          </el-option>
        </el-select>
      </div>
      <div class="list">
        <el-select
          ...
          size="mini"
        >
          <el-option v-for="item in ruleTypeList" :key="item.label" :value="item.code" :label="item.label"> </el-option>
        </el-select>
      </div>
      <div class="list">
        <el-input
