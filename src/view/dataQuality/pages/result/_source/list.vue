            ...
            <el-popover trigger="hover" placement="top">
              ...
              <div slot="reference" class="name-wrapper">
                <a href="javascript:" class="links" @click="_go(scope.row)"
                  ><span class="ellipsis" :title="scope.row.processInstanceName">{{
...
<script>
import { dataQualityTaskState, checkType, ruleType, operator, failureStrategy } from '@/view/dataQuality/_source/common'
