...
<template>
  <ListConstruction :title="'Worker ' + $t('Manage')">
          ...
          <div class="row-title">
            <div class="left">
              ...
              <span
                ...
                <a href="javascript:" @click="_showZkDirectories(item)" class="links">{{
                  $t('Directory detail')
                }}</a></span
              >
            </div>
