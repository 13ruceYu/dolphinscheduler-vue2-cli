    ...
    <template v-if="list">
      <div class="list">
        <div class="name">
          ...
          ><strong style="padding-top: 3px; display: inline-block">{{ $t('Global parameters') }}</strong>
        </div>
        <div class="var-cont">
      ...
      <div class="list" style="height: 30px">
        <div class="name">
          <em class="ri-code-s-slash-line"></em
          ><strong style="padding-top: 3px; display: inline-block">{{ $t('Local parameters') }}</strong>
        </div>
