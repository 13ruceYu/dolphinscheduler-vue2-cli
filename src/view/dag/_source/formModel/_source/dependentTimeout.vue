      ...
      <div class="cont-box">
        <label class="label-box">
          <div style="padding: 5px 0">
            <el-switch
              v-model="waitStartTimeout.enable"
              size="small"
              @change="_onSwitch(1, $event)"
              :disabled="isDetails"
            ></el-switch>
          </div>
        </label>
    ...
    <div class="clearfix list" v-if="enable && waitStartTimeout.enable">
      <div class="cont-box">
        <label class="label-box">
          ...
          <el-input
            v-model="waitStartTimeout.interval"
            size="small"
            style="width: 100px"
            :disabled="isDetails"
            maxlength="9"
          ...
          <el-input
            v-model="waitStartTimeout.checkInterval"
            size="small"
            style="width: 100px"
            :disabled="isDetails"
            maxlength="9"
    ...
    <div class="clearfix list" v-if="enable">
      ...
      <div class="cont-box">
        <label class="label-box">
          <div style="padding: 5px 0">
            <el-switch
              v-model="waitCompleteTimeout.enable"
              size="small"
              @change="_onSwitch(2, $event)"
              :disabled="isDetails"
            ></el-switch>
          </div>
        </label>
    ...
    <div class="clearfix list" v-if="enable && waitCompleteTimeout.enable">
      <div class="cont-box">
        <label class="label-box">
          ...
          <el-input
            v-model="waitCompleteTimeout.interval"
            size="small"
            style="width: 100px"
            :disabled="isDetails"
            maxlength="9"
...
export default {
  ...
  methods: {
    ...
    _verification() {
      ...
      if (
        (this.enable && this.waitCompleteTimeout.enable && !this.waitCompleteTimeout.strategy.length) ||
      ...
      const reg = /^[1-9]\d*$/
      if (
        (this.enable && this.waitCompleteTimeout.enable && !reg.test(this.waitCompleteTimeout.interval)) ||
        (this.waitStartTimeout.enable &&
          !reg.test(this.waitStartTimeout.interval || !reg.test(this.waitStartTimeout.checkInterval)))
      ) {
      ...
      if (
        this.enable &&
        this.waitStartTimeout.enable &&
        this.waitStartTimeout.checkInterval >= this.waitStartTimeout.interval
      ) {
