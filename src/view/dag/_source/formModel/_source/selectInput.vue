...
<template>
  <el-select style="width: 157px" :disabled="isDetails" size="small" @change="_onChange" v-model="selectedValue">
    <el-input
      ref="input"
      slot="trigger"
      v-if="isInput"
    ...
    <el-option v-for="city in list" :key="city" :value="city" :label="city"> </el-option>
  </el-select>
</template>
<script>
import $ from 'jquery'
