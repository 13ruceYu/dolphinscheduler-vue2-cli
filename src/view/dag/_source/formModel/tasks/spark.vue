...
<template>
  <div class="spark-model">
    <m-list-box>
      ...
      <div slot="content">
        <el-select style="width: 130px" size="small" v-model="programType" :disabled="isDetails">
          <el-option v-for="city in programTypeList" :key="city.code" :value="city.code" :label="city.code">
          </el-option>
        </el-select>
      </div>
    </m-list-box>
    <m-list-box>
      ...
      <div slot="content">
        <el-select style="width: 130px" size="small" v-model="sparkVersion" :disabled="isDetails">
          <el-option v-for="city in sparkVersionList" :key="city.code" :value="city.code" :label="city.code">
          </el-option>
        </el-select>
      </div>
    </m-list-box>
