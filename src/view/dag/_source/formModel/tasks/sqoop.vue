<template>
  <div class="sql-model">
    ...
    <template v-if="!isCustomTask">
      ...
      <m-list-box>
        ...
        <div slot="content">
          ...
          >
            <el-option v-for="city in modelTypeList" :key="city.code" :value="city.code" :label="city.code">
            </el-option>
          </el-select>
        </div>
      </m-list-box>
      <m-list-box>
        <div slot="text" style="width: 110px">
          {{ $t('Hadoop Custom Params') }}
        </div>
        <div slot="content">
          <m-local-params
      ...
      <m-list-box>
        <div slot="text" style="width: 100px">
          {{ $t('Sqoop Advanced Parameters') }}
        </div>
        <div slot="content">
          <m-local-params
      ...
      <template>
        <m-list-box>
          <div slot="text" style="font-weight: bold">
            {{ $t('Data Source') }}
          </div>
        </m-list-box>
        ...
        <m-list-box>
          ...
          <div slot="content">
            ...
            >
              <el-option v-for="city in sourceTypeList" :key="city.code" :value="city.code" :label="city.code">
              </el-option>
            </el-select>
          </div>
        </m-list-box>
          ...
          <m-list-box>
            ...
            <div slot="content">
              <m-datasource
                ...
                :data="{
                  type: sourceMysqlParams.srcType,
      ...
      <m-list-box v-show="srcQueryType === '1' && sourceType === 'MYSQL'">
        ...
        <div slot="content">
          <div class="from-mirror">
            <textarea id="code-sqoop-mirror" name="code-sqoop-mirror" style="opacity: 0"> </textarea>
      ...
      <m-list-box>
        <div slot="text">{{ $t('Type') }}</div>
        <div slot="content">
          <el-select style="width: 130px" size="small" v-model="targetType" :disabled="isDetails">
            <el-option v-for="city in targetTypeList" :key="city.code" :value="city.code" :label="city.code">
            </el-option>
          </el-select>
        </div>
      </m-list-box>
        ...
        <m-list-box>
          ...
          <div slot="content">
            <m-datasource
              ...
              :data="{
                type: targetMysqlParams.targetType,
                typeList: [{ id: 0, code: 'MYSQL', disabled: false }],
    ...
    <el-dialog :visible.sync="scriptBoxDialog" append-to-body="true" width="80%">
...
import codemirror from '@/view/resource/pages/file/pages/_source/codemirror'
      ...
      switch (this.sourceType) {
        case 'MYSQL':
          this.sourceMysqlParams.srcQuerySql =
            this.sourceMysqlParams.srcQueryType === '1' && editor
              ? editor.getValue()
              : this.sourceMysqlParams.srcQuerySql
