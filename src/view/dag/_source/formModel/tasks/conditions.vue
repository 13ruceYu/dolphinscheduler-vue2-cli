...
<template>
  <div class="dependence-model">
    <m-list-box>
      ...
      <div slot="content">
        <div class="dep-opt">
          <a href="javascript:" @click="!isDetails && _addDep()" class="add-dep">
            <em
              v-if="!isLoading"
        ...
        <div class="dep-box">
          <span class="dep-relation" @click="!isDetails && _setGlobalRelation()" v-if="dependTaskList.length">
            {{ relation === 'AND' ? $t('and') : $t('or') }}
          </span>
          <div class="dep-list" v-for="(el, $index) in dependTaskList" :key="$index">
            <span class="dep-line-pie" v-if="el.dependItemList.length" @click="!isDetails && _setRelation($index)">
              {{ el.relation === 'AND' ? $t('and') : $t('or') }}
            </span>
            <em
              class="el-icon-delete dep-delete"
              data-toggle="tooltip"
              data-container="body"
              :class="_isDetails"
