...
<template>
  <div class="udfs-model">
    <el-select multiple v-model="udfsStr" :disabled="isDetails" size="small" style="width: 100%">
      <el-option v-for="city in udfsList" :key="city.id" :value="city.id" :label="city.code"> </el-option>
    </el-select>
  </div>
</template>
<script>
