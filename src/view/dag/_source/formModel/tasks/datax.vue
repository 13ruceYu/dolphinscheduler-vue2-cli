  ...
  <div class="datax-model">
    ...
    <div v-if="!enable">
      ...
      <m-list-box>
        ...
        <div slot="content">
          <m-select-input v-model="jobSpeedByte" :list="[0, 1, 10, 50, 100, 512]"> </m-select-input>
      ...
      <m-list-box>
        ...
        <div slot="content">
          <m-select-input v-model="jobSpeedRecord" :list="[0, 500, 1000, 1500, 2000, 2500, 3000]"> </m-select-input>
    ...
    <div v-else>
      <m-list-box>
        ...
        <div slot="content">
          <div class="from-mirror">
            <textarea id="code-json-mirror" name="code-json-mirror" style="opacity: 0"> </textarea>
          </div>
        </div>
      </m-list-box>
      <m-list-box>
    ...
    <div class="clearfix list">
      ...
      <div class="cont-box">
        ...
        <m-select-input v-model="xms" :list="[1, 2, 3, 4]"> </m-select-input>
        <span>&nbsp;&nbsp;&nbsp;G &nbsp;&nbsp;</span>
        <span>{{ $t('Max Memory') }}</span>
        <m-select-input v-model="xmx" :list="[1, 2, 3, 4]"> </m-select-input>
        <span>&nbsp;&nbsp;&nbsp;G</span>
      </div>
    </div>
