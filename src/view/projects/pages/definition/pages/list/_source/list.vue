<template>
  <div class="list-model" style="position: relative">
          ...
          <template slot-scope="scope">
            ...
            <el-tooltip :content="$t('Timing')" placement="top" :enterable="false">
              <el-button
                ...
                size="mini"
                icon="el-icon-time"
                :disabled="scope.row.releaseState !== 'ONLINE' || scope.row.scheduleReleaseState !== null"
    ...
    <el-dialog :title="$t('Set parameters before timing')" :visible.sync="timingDialog" width="auto">
      <m-timing :timingData="timingData" @onUpdateTiming="onUpdateTiming" @closeTiming="closeTiming"></m-timing>
    </el-dialog>
    <el-dialog :title="$t('Info')" :visible.sync="relatedItemsDialog" width="auto">
      <m-related-items
        :tmp="tmp"
...
import { publishStatus } from '@/view/dag/_source/config'
