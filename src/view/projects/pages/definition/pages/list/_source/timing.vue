...
<template>
  <div class="timing-process-model">
        ...
        <template>
          <el-popover placement="bottom-start" trigger="click">
            <template slot="reference">
              <el-input style="width: 360px" type="text" size="small" readonly :value="crontab"> </el-input>
            </template>
    ...
    <div class="clearfix list">
      ...
      <div class="cont">
        <el-select style="width: 200px" size="small" v-model="warningType">
          <el-option v-for="city in warningTypeList" :key="city.id" :value="city.id" :label="city.code"> </el-option>
        </el-select>
      </div>
    </div>
    <div class="clearfix list">
        ...
        >
          ...
          >
            <em
              ...
              v-show="warningGroupId.id"
            ></em>
            <em slot="suffix" class="el-icon-bottom" style="font-size: 12px" v-show="!warningGroupId.id"></em>
          </el-input>
          <el-option v-for="city in notifyGroupList" :key="city.id" :value="city.id" :label="city.code"> </el-option>
        </el-select>
      </div>
    </div>
    <div class="submit">
...
import { vCrontab } from '@/components/crontab/index'
import { formatDate } from '@/module/filter/filter'
import mPriority from '@/components/priority/priority'
import mWorkerGroups from '@/view/dag/_source/formModel/_source/workerGroups'
