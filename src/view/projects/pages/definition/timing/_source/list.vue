...
<template>
  <div>
    <div class="conditions-box">
      <!--<Conditions @on-conditions="_onConditions"></Conditions>-->
    </div>
...
export default {
  ...
  mounted() {},
  components: { Spin, NoData, mTiming },
}
</script>
