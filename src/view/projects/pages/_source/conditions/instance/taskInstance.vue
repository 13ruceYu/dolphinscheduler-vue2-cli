  ...
  <Conditions>
    <template slot="search-group">
      ...
      <div class="list">
        <el-select
          style="width: 140px"
          @change="_onChangeState"
          :value="searchParams.stateType"
          :placeholder="$t('State')"
          size="mini"
        >
          <el-option v-for="city in stateTypeList" :key="city.label" :value="city.code" :label="city.label">
          </el-option>
        </el-select>
      </div>
      <div class="list">
        <el-input
          v-model="searchParams.host"
      ...
      <div class="list">
        <el-input
          v-model="searchParams.executorName"
          @keyup.enter.native="_ckQuery"
          style="width: 140px"
          size="mini"
      ...
      <div class="list">
        <el-input
          v-model="searchParams.processInstanceName"
          @keyup.enter.native="_ckQuery"
          style="width: 160px"
          size="mini"
          :placeholder="$t('Process Instance')"
        ></el-input>
      </div>
      <div class="list">
        <el-input
