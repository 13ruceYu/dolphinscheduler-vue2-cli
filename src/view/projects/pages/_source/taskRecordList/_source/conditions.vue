...
<template>
  <Conditions>
    <template slot="search-group">
      ...
      <div class="list">
        <el-input
          v-model="searchParams.destTable"
          style="width: 120px"
          size="mini"
          :placeholder="$t('Target Table')"
        ></el-input>
      </div>
      <div class="list">
        <el-input
          v-model="searchParams.sourceTable"
          style="width: 120px"
          size="mini"
          :placeholder="$t('Source Table')"
        ></el-input>
      </div>
      <div class="list">
        <el-select
          ...
          size="mini"
        >
          <el-option v-for="city in stateList" :key="city.label" :value="city.code" :label="city.label"> </el-option>
        </el-select>
      </div>
      <div class="list">
        <el-date-picker
