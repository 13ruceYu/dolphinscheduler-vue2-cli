...
<template>
  <div class="wrap-taskInstance">
    <ListConstruction :title="$t('Task Instance')">
...
import mInstanceConditions from '@/view/projects/pages/_source/conditions/instance/taskInstance'

export default {
  name: 'ProjectsTaskInstance',
  ...
  methods: {
    ...
    _getList(flag) {
      ...
      this.getTaskInstanceList(this.searchParams)
        .then((res) => {
