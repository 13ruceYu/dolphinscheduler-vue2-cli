...
export default {
  ...
  'The os tenant code. Only letters or a combination of letters and numbers are allowed':
    '操作系统租户只允许字母或字母与数字组合',
  'Edit User': '编辑用户',
  Tenant: '租户',
  Email: '邮件',
  ...
  Failure: '失败',
  'Rule Type': '规则类型',
  'Statistics Value': '统计值',
  'Comparison Value': '比对值',
  'Comparison Type': '比对值类型',
  'Check Type': '检测类型',
  Operator: '操作符',
  Threshold: '阈值',
  'Single Table': '单表检测',
  'Single Table Custom Sql': '自定义SQL',
  'Multi Table Accuracy': '跨表准确性',
  'Multi Table Comparison': '跨表值对比',
  '(Comparison-Statistics)/Comparison Percentage': '(比对值-统计值)/比对值',
  'Comparison Statistics Difference': '比对值-统计值',
