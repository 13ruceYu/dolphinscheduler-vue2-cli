...
<template>
  <m-popup
    :ok-text="$t('Submit')"
    :nameText="resourceData.type.name + $t('Authorize')"
    @ok="_ok"
    @close="close"
    ref="popup"
  >
    <template slot="content">
      <div class="clearfix transfer-model" style="width: 660px">
        ...
        <treeselect
          v-show="checkedValue == 'fileResource'"
          v-model="selectFileSource"
          :multiple="true"
          maxHeight="200"
          :options="fileList"
        ...
        <treeselect
          v-show="checkedValue == 'udfResource'"
          v-model="selectUdfSource"
          :multiple="true"
          maxHeight="200"
          :options="udfList"
          :normalizer="normalizer"
