  ...
  <div class="v-crontab">
    ...
    <div class="v-crontab-model">
      <div class="clearfix v-crontab-tab">
        <a href="javascript:" :class="tabVal === 'second' ? ' active' : ''" @click="onTab('second')"
          ><em class="el-icon-date"></em><span>{{ $t('秒') }}</span></a
        >
        <a href="javascript:" :class="tabVal === 'minute' ? ' active' : ''" @click="onTab('minute')"
          ><em class="el-icon-date"></em><span>{{ $t('分') }}</span></a
        >
        <a href="javascript:" :class="tabVal === 'hour' ? ' active' : ''" @click="onTab('hour')"
          ><em class="el-icon-date"></em><span>{{ $t('时') }}</span></a
        >
        <a href="javascript:" :class="tabVal === 'day' ? ' active' : ''" @click="onTab('day')"
          ><em class="el-icon-date"></em><span>{{ $t('天') }}</span></a
        >
        <a href="javascript:" :class="tabVal === 'month' ? ' active' : ''" @click="onTab('month')"
          ><em class="el-icon-date"></em><span>{{ $t('月') }}</span></a
        >
        <a href="javascript:" :class="tabVal === 'year' ? ' active' : ''" @click="onTab('year')"
          ><em class="el-icon-date"></em><span>{{ $t('年') }}</span></a
        >
      </div>
      <div class="v-crontab-content">
        ...
        <template v-if="tabVal === 'day'">
          <m-day
            @on-day-value="_onDayValue"
            @on-week-value="_onWeekValue"
            :day-val="dayVal"
            :week-val="weekVal"
          ></m-day>
        </template>
