        ...
        <div class="list-box">
          <el-radio label="specificHour" size="mini">
            ...
            <el-select
              ...
              @change="onspecificHours"
            >
              <el-option v-for="item in selectHourList" :key="item.value" :value="item.value" :label="item.label">
              </el-option>
            </el-select>
          </el-radio>
        </div>
  ...
  methods: {
    ...
    analyticalValue() {
      return new Promise((resolve, reject) => {
        ...
        if (
          ($hourVal.length === 1 && _.isInteger(parseInt($hourVal))) ||
