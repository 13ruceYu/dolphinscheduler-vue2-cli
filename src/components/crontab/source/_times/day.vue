        ...
        <div class="list-box">
          <el-radio label="WkintervalWeek">
            ...
            <m-input-number
              :min="0"
              :max="7"
              :props-value="parseInt(WkintervalWeekPerformVal)"
              @on-number="onWkintervalWeekPerform"
            ></m-input-number>
            <span class="text" style="margin-left: 65px">{{ $t('天执行 从') }}</span>
            <el-select
              :placeholder="$t('请选择具体小时数')"
              style="width: 200px"
              size="mini"
              v-model="WkintervalWeekStartVal"
            >
              <el-option v-for="item in selectWeekList" :key="item.value" :value="item.value" :label="item.label">
              </el-option>
            </el-select>
        ...
        <div class="list-box">
          <el-radio label="intervalDay" size="mini">
            ...
            <m-input-number
              :min="0"
              :max="31"
              :props-value="parseInt(intervalDayPerformVal)"
              @on-number="onIntervalDayPerform"
            ></m-input-number>
            <span class="text" style="margin-left: 65px">{{ $t('天执行 从') }}</span>
            <m-input-number
              :min="1"
              :max="31"
              :props-value="parseInt(intervalDayStartVal)"
              @on-number="onIntervalDayStart"
            ></m-input-number>
        ...
        <div class="list-box">
          <el-radio label="monthLastWeeks" size="mini">
            ...
            <el-select size="mini" :placeholder="$t('请选择具体周几')" v-model="monthLastWeeksVal">
              <el-option v-for="item in monthLastWeeksList" :key="item.value" :value="item.value" :label="item.label">
              </el-option>
            </el-select>
          </el-radio>
        </div>
        <div class="list-box">
          <el-radio label="monthTailBefore" size="mini">
            <m-input-number
              :min="0"
              :max="31"
              :props-value="parseInt(monthTailBeforeVal)"
              @on-number="onMonthTailBefore"
            ></m-input-number>
        ...
        <div class="list-box">
          <el-radio label="recentlyWorkingDaysMonth" size="mini">
            ...
            <m-input-number
              :min="0"
              :max="31"
              :props-value="parseInt(recentlyWorkingDaysMonthVal)"
              @on-number="onRecentlyWorkingDaysMonth"
            ></m-input-number>
        ...
        <div class="list-box">
          <el-radio label="WkmonthNumWeeks" size="mini">
            ...
            <m-input-number
              :min="0"
              :max="31"
              :props-value="parseInt(WkmonthNumWeeksDayVal)"
              @on-number="onWkmonthNumWeeksDay"
            ></m-input-number>
            <el-select
              :placeholder="$t('请选择具体周几')"
              size="mini"
              style="width: 200px; margin-left: 65px"
              v-model="WkmonthNumWeeksWeekVal"
            >
              <el-option
