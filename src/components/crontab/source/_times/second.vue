      ...
      <el-radio-group v-model="radioSecond" vertical size="mini">
        ...
        <div class="list-box">
          <el-radio label="intervalSecond">
            ...
            ></m-input-number>
            <span class="text" style="margin-left: 65px">{{ $t('秒执行 从') }}</span>
            <m-input-number
              :min="0"
              :max="59"
            ...
            ></m-input-number>
            <span class="text" style="margin-left: 65px">{{ $t('秒开始') }}</span>
          </el-radio>
        </div>
        <div class="list-box">
          <el-radio label="specificSecond">
            ...
            <el-select
              multiple
              size="mini"
              :placeholder="$t('请选择具体秒数')"
              v-model="specificSecondsVal"
              @change="onSpecificSeconds"
            >
              <el-option v-for="item in selectSecondList" :key="item.value" :value="item.value" :label="item.label">
              </el-option>
            </el-select>
          </el-radio>
        </div>
        <div class="list-box">
          <el-radio label="cycleSecond">
            ...
            ></m-input-number>
            <span class="text" style="margin-left: 65px">{{ $t('秒') }}</span>
          </el-radio>
        </div>
      </el-radio-group>
    </div>
  ...
  methods: {
    ...
    analyticalValue() {
      return new Promise((resolve, reject) => {
        ...
        if (
          ($secondVal.length === 1 && _.isInteger(parseInt($secondVal))) ||
