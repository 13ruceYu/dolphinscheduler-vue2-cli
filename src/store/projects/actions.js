...
export default {
   ...
   */
  getTaskStatusCount(ctx, payload) {
    return new Promise((resolve, reject) => {
   ...
   */
  getCommandStateCount(ctx, payload) {
    return new Promise((resolve, reject) => {
   ...
   */
  getProcessStateCount(ctx, payload) {
    return new Promise((resolve, reject) => {
   ...
   */
  getDefineUserCount(ctx, payload) {
    return new Promise((resolve, reject) => {
