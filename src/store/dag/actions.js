...
export default {
  ...
  getTaskState({ state }, payload) {
    return new Promise((resolve, reject) => {
      io.get(
        `projects/${state.projectName}/instance/task-list-by-process-id`,
        {
  ...
  editProcessState({ state }, payload) {
    return new Promise((resolve, reject) => {
      io.post(
        `projects/${state.projectName}/process/release`,
        {
  ...
  editExecutorsState({ state }, payload) {
    return new Promise((resolve, reject) => {
      io.post(
        `projects/${state.projectName}/executors/execute`,
        {
  ...
  verifDAGName({ state }, payload) {
    return new Promise((resolve, reject) => {
      io.get(
        `projects/${state.projectName}/process/verify-name`,
        {
          name: payload,
        },
        (res) => {
  ...
  getProcessDetails({ state }, payload) {
    return new Promise((resolve, reject) => {
      io.get(
        `projects/${state.projectName}/process/select-by-id`,
        {
          processId: payload,
        },
        (res) => {
  ...
  copyProcess({ state }, payload) {
    return new Promise((resolve, reject) => {
      io.post(
        `projects/${state.projectName}/process/copy`,
        {
  ...
  moveProcess({ state }, payload) {
    return new Promise((resolve, reject) => {
      io.post(
        `projects/${state.projectName}/process/move`,
        {
          processDefinitionIds: payload.processDefinitionIds,
          targetProjectId: payload.targetProjectId,
        },
  ...
  getInstancedetail({ state }, payload) {
    return new Promise((resolve, reject) => {
      io.get(
        `projects/${state.projectName}/instance/select-by-id`,
        {
          processInstanceId: payload,
        },
        (res) => {
  ...
  saveDAGchart({ state }, payload) {
    return new Promise((resolve, reject) => {
      ...
      io.post(
        `projects/${state.projectName}/process/save`,
        {
  ...
  updateDefinition({ state }, payload) {
    return new Promise((resolve, reject) => {
      ...
      io.post(
        `projects/${state.projectName}/process/update`,
        {
          processDefinitionJson: JSON.stringify(data),
          locations: JSON.stringify(state.locations),
          connects: JSON.stringify(state.connects),
  ...
  updateInstance({ state }, payload) {
    return new Promise((resolve, reject) => {
      ...
      io.post(
        `projects/${state.projectName}/instance/update`,
        {
  ...
  exportDefinition({ state }, payload) {
    ...
    io.get(
      `projects/${state.projectName}/process/export`,
      { processDefinitionIds: payload.processDefinitionIds },
      (res) => {
